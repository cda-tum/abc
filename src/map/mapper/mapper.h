...
extern void            Map_ManSetPowerRecovery( Map_Man_t * p, int fAreaRecovery );
...
/*=== mapperLib.c =============================================================*/
extern int             Map_SuperLibDeriveFromGenlib( Mio_Library_t * pLib, int fDynPower,int fVerbose );
