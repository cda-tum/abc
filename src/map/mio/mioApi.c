...
float             Mio_LibraryReadPowerInv      ( Mio_Library_t * pLib )  { return (float)(pLib->pGateInv?   pLib->pGateInv->dPower_swi   : 0.0); }
float             Mio_LibraryReadPowerBuf      ( Mio_Library_t * pLib )  { return (float)(pLib->pGateBuf?   pLib->pGateBuf->dPower_swi   : 0.0); }
